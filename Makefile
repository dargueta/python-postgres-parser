...
AUTOGENERATED_FILES= $(AUTOGENERATED_PXD_FILES) $(AUTOGENERATED_PYX_FILES) $(AUTOGENERATED_PYTHON_FILES) $(AUTOGENERATED_PROTOBUF_FILES) $(AUTOGENERATED_C_FILES)
H2W_ARGS=--hooks build-tools/h2w_hooks.py
LIBPGQUERY_HEADER_FILES=$(LIBPGQUERY_DIR)/pg_query.h


.PHONY: distfiles
distfiles: $(AUTOGENERATED_FILES) $(CYTHON_SOURCES)
...
clean:
	...
	find $(SRC_ROOT) \( -name '*.so' -o -name '*.pyd' \) -delete
